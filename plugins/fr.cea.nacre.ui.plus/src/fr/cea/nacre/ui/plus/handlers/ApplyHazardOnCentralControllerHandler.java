...
public class ApplyHazardOnCentralControllerHandler extends CmdHandler {


	public ApplyHazardOnCentralControllerHandler() {
		super();
	}
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (eo instanceof Element) {
			...
			if (UMLUtil.getStereotypeApplication(element, MainGrid.class)!=null) {
				nacreModelerHelper.getSRCentralControlerFromMainGrid( element, swSchedulableResourceList);
			}
			
			if (UMLUtil.getStereotypeApplication(element, CentralController.class)!=null) {
