...
public class CreateLineHandler extends CmdHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		transactionalEditingDomain.getCommandStack().execute(new CreateLineCommand(transactionalEditingDomain, selectedEObject));
		return null;
	}
