...
public class ApplyHazardOnZonalControllerHandler extends CmdHandler {


	public ApplyHazardOnZonalControllerHandler() {
		super();
	}
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (eo instanceof Element) {
			...
			if (UMLUtil.getStereotypeApplication(element, MainGrid.class)!=null) {
				nacreModelerHelper.getSRZonalControlerFromMainGrid( element, swSchedulableResourceList);
			}
			if (UMLUtil.getStereotypeApplication(element, Zone.class)!=null) {
				nacreModelerHelper.getSRZonalControlerFromZone(element, swSchedulableResourceList);
			}
			if (UMLUtil.getStereotypeApplication(element, ZonalController.class)!=null) {
				swSchedulableResourceList.addAll(nacreModelerHelper.getSRFromController(element));
			}
