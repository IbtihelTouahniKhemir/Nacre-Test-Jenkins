...
import fr.cea.nacre.ui.plus.command.CopyCRACommand;

/**
 * this handler is used to copy a CRA package with the associated CFRA
 */
public class CopyCRAHandler extends CmdHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		transactionalEditingDomain.getCommandStack().execute(new CopyCRACommand(transactionalEditingDomain, selectedEObject));
		return null;
	}
	@Override
