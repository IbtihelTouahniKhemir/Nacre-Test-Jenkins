...
public class LinkEditHelperAdvice extends AbstractEditHelperAdvice {
	...
	public boolean approveRequest(IEditCommandRequest request) {
		...
		if (request instanceof CreateRelationshipRequest) {
			...
			if (elementType instanceof ISpecializationType) {
				if (isSpecializationof((ISpecializationType) elementType, NACREElementTypesEnumerator.LINK)) {
	...
	private boolean approveCreateRelationshipRequest(CreateRelationshipRequest createRelationshipRequest) {
		...
		if ((source instanceof Element) && (target instanceof Element)) {
			...
			if (UMLUtil.getStereotypeApplication((Element) source, CommunicationMedia.class) != null
