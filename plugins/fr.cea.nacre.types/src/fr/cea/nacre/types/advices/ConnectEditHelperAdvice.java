...
public class ConnectEditHelperAdvice extends AbstractEditHelperAdvice {
	...
	private boolean approveCreateRelationshipRequest(CreateRelationshipRequest createRelationshipRequest) {
		...
		if ((source instanceof Element) && (target instanceof Element)) {
			...
			if (UMLUtil.getStereotypeApplication((Element) source, SwSchedulableResource.class) != null
					&& UMLUtil.getStereotypeApplication((Element) target, ComputingResource.class) != null) {
				return true;
			}
		}
		return false;
