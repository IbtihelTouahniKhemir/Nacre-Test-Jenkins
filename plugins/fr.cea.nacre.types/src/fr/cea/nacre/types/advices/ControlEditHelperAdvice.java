...
public class ControlEditHelperAdvice extends AbstractEditHelperAdvice {
	...
	public boolean approveRequest(IEditCommandRequest request) {
		...
		if (request instanceof CreateRelationshipRequest) {
			...
			if (elementType instanceof ISpecializationType) {
				if (isSpecializationof((ISpecializationType) elementType, NACREElementTypesEnumerator.CONTROL)) {
		...
		if ((source instanceof Element) && (target instanceof Element)) {
			...
			if (UMLUtil.getStereotypeApplication((Element) source, LocalController.class) != null
					&& (UMLUtil.getStereotypeApplication((Element) target, Generator.class) != null
							|| UMLUtil.getStereotypeApplication((Element) target, Battery.class) != null
							|| UMLUtil.getStereotypeApplication((Element) target, RTE_Installation.class) != null)) {
				return true;
			}
		}
		return false;
