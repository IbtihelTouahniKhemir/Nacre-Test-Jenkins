/**
 */
package fr.cea.nacre.model.NACREMM.study.util;
...
public class StudyAdapterFactory extends AdapterFactoryImpl {
	...
	protected StudySwitch<Adapter> modelSwitch =
		new StudySwitch<Adapter>() {
			...
			@Override
			public Adapter caseUsingDirectives(UsingDirectives object) {
				return createUsingDirectivesAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.cea.nacre.model.NACREMM.study.Study <em>Study</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.cea.nacre.model.NACREMM.study.Manifest <em>Manifest</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.cea.nacre.model.NACREMM.study.UsingDirectives <em>Using Directives</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createUsingDirectivesAdapter() {
		return null;
	}
