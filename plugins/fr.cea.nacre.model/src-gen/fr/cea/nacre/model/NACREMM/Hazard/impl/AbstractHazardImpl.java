 ...
 * </p>
 * <ul>
 *   <li>{@link fr.cea.nacre.model.NACREMM.Hazard.impl.AbstractHazardImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link fr.cea.nacre.model.NACREMM.Hazard.impl.AbstractHazardImpl#getJustification <em>Justification</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AbstractHazardImpl extends UIDElementImpl implements AbstractHazard {
	/**
	...
	protected EClass eStaticClass() {
		return HazardPackage.Literals.ABSTRACT_HAZARD;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HazardPackage.ABSTRACT_HAZARD__DESCRIPTION, oldDescription, description));
	}
	...
	public void setJustification(String newJustification) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HazardPackage.ABSTRACT_HAZARD__JUSTIFICATION, oldJustification, justification));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HazardPackage.ABSTRACT_HAZARD__DESCRIPTION:
				return getDescription();
			case HazardPackage.ABSTRACT_HAZARD__JUSTIFICATION:
